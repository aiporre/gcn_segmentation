...
then
  ...
  echo "Running upool proportional"
  tid="pPre5Ch$fold"
  python training.py -s GISLES2018 -n GFCNE -b 4 -c DCSsigmoid -t True -N 10 --id $tid -lr 1E-4  -g 100 -f $tfold --postnorm False -X True -D experiment4_upool -W True>> "experiment4_upool/gfcne_${tid}_eval.log"
