...
then
  ...
  tid="uPre4Ch$fold"
  python training.py -s GISLES2018 -n GFCNE -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6 -g 100 --mod TMAX CBF CBV MTT --postnorm False -D experiment4_upool -W True>> "experiment4_upool/gfcne_$tid.log"
  ...
  tid="nPre4Ch$fold"
  python training.py -s GISLES2018 -n GFCNF -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6 -g 100 --mod TMAX CBF CBV MTT --postnorm False -D experiment4_upool >> "experiment4_upool/gfcnf_$tid.log"
elif [[ $channels == "5ch" ]]
then
