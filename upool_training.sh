...
then
  ...
  tid="kPre4Ch$fold"
  python training.py -s GISLES2018 -n GFCNG -b 10 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-4  -g 100 -f $tfold --mod TMAX CBF CBV MTT --postnorm False -D experiment4_upool >> "experiment4_upool/gfcng_$tid.log"
  echo "Running no unpool and pooling"
  tid="nPre4Ch$fold"
  python training.py -s GISLES2018 -n GFCNF -b 2 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6  -g 100 -f $tfold --mod TMAX CBF CBV MTT --postnorm False -D experiment4_upool >> "experiment4_upool/gfcnf_$tid.log"
elif [[ $channels == "5ch" ]]
then
  ...
  tid="uPre5Ch$fold"
  python training.py -s GISLES2018 -n GFCNE -b 4 -c DCSsigmoid -t True -N 10 --id $tid -lr 1E-6  -g 100 -f $tfold --postnorm False -D experiment4_upool -W True>> "experiment4_upool/gfcne_$tid.log"
  echo "Running upool topk"
  tid="kPre5Ch$fold"
  python training.py -s GISLES2018 -n GFCNG -b 8 -c DCSsigmoid -t True -N 10 --id $tid -lr 1E-6  -g 100 -f $tfold --postnorm False -D experiment4_upool >> "experiment4_upool/gfcng_$tid.log"
  echo "Running no unpool and pooling"
  tid="nPre5Ch$fold"
...
then
  ...
  echo "Running topk"
  tid="kPre1ChCBV$fold"
  python training.py -s GISLES2018 -n GFCNG -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6  -g 100 -f $tfold --mod CBV --postnorm False -D experiment4_upool >> "experiment4_upool/gfcnd_$tid.log"
#
...
then
  ...
  echo "Running topk"
  tid="kPre1ChCBF$fold"
  python training.py -s GISLES2018 -n GFCNG -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6  -g 100 -f $tfold --mod CBF --postnorm False -D experiment4_upool >> "experiment4_upool/gfcnd_$tid.log"
else
