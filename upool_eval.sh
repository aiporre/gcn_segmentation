...
then
  ...
  tid="uPre4Ch$fold"
  python training.py -s GISLES2018 -n GFCNC -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6 -g 100 -X True --mod TMAX CBF CBV MTT --postnorm False -D experiment4_upool -W True>> "experiment4_upool/gfcnc_${tid}_eval.log"
...
then
  ...
  echo "Running upool proportional"
  tid="uPre5Ch$fold"
  python training.py -s GISLES2018 -n GFCNC -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6 -g 100 -X True --postnorm False -D experiment4_upool -W True>> "experiment4_upool/gfcnc_${tid}_eval.log"
  echo "Running upool topk"
  tid="kPre5Ch$fold"
...
then
  ...
  echo "Training upool proportional vs topk"
  tid="uPre1ChCBV$fold"
  python training.py -s GISLES2018 -n GFCNC -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6 -g 100 -X True --mod CBV --postnorm False -D experiment4_upool -W True>> "experiment4_upool/gfcnc_${tid}_eval.log"
  echo "Running upool topk"
  tid="kPre1ChCBV$fold"
...
then
  ...
  echo "Training upool proportional vs topk"
  tid="uPre1ChCBF$fold"
  python training.py -s GISLES2018 -n GFCNC -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6 -g 100 -X True --mod CBF --postnorm False -D experiment4_upool -W True>> "experiment4_upool/gfcnc_${tid}_eval.log"
  echo "Running upool topk"
  tid="kPre1ChCBF$fold"
