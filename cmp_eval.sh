...
then
  ...
  tid="Pre5Ch$fold"
  echo "GFCNC with soft Dice loss"
  python training.py -s GISLES2018 -n GFCNC -b 4 -c DCSsigmoid  -t True -N 10 --id $tid -lr 1E-6 -X True -g 100 -f $tfold --postnorm False -D experiment5_cmp >> "experiment5_cmp/gfcnc_${tid}_eval.log"
