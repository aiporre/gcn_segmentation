...
#  rm data/gisles/processed/TRAINING/gendo_*.pt
  ...
  python training.py -s GISLES2018 -n GFCNC -b 7 -c FLsigmoid  -t True -N 10 --id $tid -lr 1E-6  -g 200 -f $tfold --mod TMAX CBF CBV MTT --postnorm False -D experiment5_cmp >> "experiment5_cmp/gfcnc_$tid.log"
elif [[ $channels == "5ch" ]]
then
  echo " Deleting files gendo_"
